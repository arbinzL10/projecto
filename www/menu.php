...
<div id="menu" >
	...
	{?>						
			...
			<div class="item" >				
				<img name="button_map" style="margin-top:10%;" src="images/button_map.png" onclick="HTTPReq(new Array('type_map','option'),new Array('map_joueur','init'),'aff_map.php','main')" onMouseOver="document.button_map.src='images/button_map_clicked.png';"onMouseOut="document.button_map.src='images/button_map.png';">
			</div>
			<div class="item" >				
			...
			<div id="chateau_item" class="item"   >
				<img name="button_chateau" style="margin-top:10%;" src="images/button_chateaux.png" onMouseOver="document.button_chateau.src='images/button_chateaux_clicked.png';" onMouseOut="document.button_chateau.src='images/button_chateaux.png';" onclick="addSideMenu('menuG.php','main','menuChateau');olrollovermenu=null;" />
			</div>
